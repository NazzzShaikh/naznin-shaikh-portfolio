        ...
        <div className="w-full lg:max-w-5xl text-left">
          ...
          >
            ...
            <div className="space-y-6 text-lg md:text-xl text-white/70 leading-relaxed font-light">
              ...
              <p>
                Currently, I am working as a <span className="text-white font-medium italic">Java Developer Intern</span> at <span className="text-white font-medium italic">Keyanna Technology Pvt. Ltd.</span>
              </p>
              <p>
            ...
            <div className="mt-20 pt-10 flex flex-col items-center border-t border-white/5 opacity-60">
               <p className="text-sm tracking-[0.4em] uppercase text-white/50 mb-4 text-center">Ahmedabad, Gujarat, India</p>
               <div className="flex items-center justify-center gap-4">
                  <span className="w-8 h-[1px] bg-cyan-primary" />
                  <p className="text-xs tracking-[0.2em] uppercase text-white/80 font-medium text-center">Naznin Shaikh</p>
                  <span className="w-8 h-[1px] bg-cyan-primary" />
               </div>
            </div>
          </motion.div>
